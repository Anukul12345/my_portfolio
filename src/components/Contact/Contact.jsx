    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl mb-12">
        <div className="flex items-center space-x-4 bg-[#0d081f] p-4 rounded-lg border border-gray-700">
          ...
          <a
            href="mailto:anukul.chauhan_cs22@gla.ac.in"
            className="text-gray-300 hover:text-purple-400"
          >
            anukulchauhan312@gmail.com
          </a>
        </div>
        <div className="flex items-center space-x-4 bg-[#0d081f] p-4 rounded-lg border border-gray-700">
          <FaPhone className="text-purple-500 text-2xl" />
          <a
            href="tel:+918126576101"
            className="text-gray-300 hover:text-purple-400"
          >
            +91 8126576101
          </a>
        ...
        <div className="flex items-center space-x-4 bg-[#0d081f] p-4 rounded-lg border border-gray-700">
          ...
          <a
            href="https://www.linkedin.com/in/anukul-singh-chauhan-a44636289/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-300 hover:text-purple-400"
          >
            linkedin.com/in/anukul-singh-chauhan
          </a>
        </div>
        <div className="flex items-center space-x-4 bg-[#0d081f] p-4 rounded-lg border border-gray-700">
          ...
          <a
            ...
            className="text-gray-300 hover:text-purple-400"
          >
            github.com/Anukul12345
          </a>
        </div>
        <div className="flex items-center space-x-4 bg-[#0d081f] p-4 rounded-lg border border-gray-700">
          <FaMapMarkerAlt className="text-purple-500 text-2xl" />
          <span className="text-gray-300">Badaun, India</span>
        </div>
      </div>
